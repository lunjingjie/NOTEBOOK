...
import { Injectable, Optional, Inject, LoggerService as NestLoggerService } from '@nestjs/common';
...
export class LoggerService implements NestLoggerService {
	...
	constructor(
		...
		// 控制台输出等级
		!this.options.consoleLevel && (this.options.consoleLevel = DEFAULT_LOG_CONSOLE_LEVELS);
		// 输出的文件大小
		...
		!this.options.errorLogName && (this.options.errorLogName = DEFAULT_ERROR_LOG_NAME);
